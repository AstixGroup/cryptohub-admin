...
export type SocialBadge = "TWITTER" | "FACEBOOK" | "TELEGRAM" | "INSTAGRAM" | "YOUTUBE"
...
export const customizedSocialMediaBadge = (badge: SocialBadge) => {
    switch (badge) {
        case "INSTAGRAM":
            return <IoLogoInstagram className={"size-6 text-red-500"}/>
        case "YOUTUBE":
            return <IoLogoYoutube className={"size-6 text-red-500"}/>
        case "TWITTER":
            return <IoLogoTwitter className={"size-6 text-blue-500"}/>
        case "FACEBOOK":
            return <IoLogoFacebook className={"size-6 text-blue-500"}/>
        case "TELEGRAM":
            return <SiTelegram className={"size-6 text-blue-500"}/>
    }
}